...
Implement three batches of N Monte Carlo sample evaluations.
...
Add handling for the SIGINT signal, which interrupts further batch computation.
...
Add handling for process termination while holding a mutex in shared memory outside of the initialization procedure.
